...
const FALLBACK_CONSTITUENCIES = [
  {id:'con1',name:'New Delhi',state:'Delhi',type:'Lok Sabha',currentMP:'Rajesh Kumar Sharma',currentParty:'BJP',voters:1850000,turnout2019:62.3,literacy:86,population:9800000,area:'42.7 sq km',pollingStations:2100,reservationCategory:'General',districts:['New Delhi'],urbanRural:'Urban'},
  {id:'con2',name:'Lucknow',state:'Uttar Pradesh',type:'Lok Sabha',currentMP:'Vikram Chandra Gupta',currentParty:'BJP',voters:2100000,turnout2019:58.1,literacy:78,population:11200000,area:'2528 sq km',pollingStations:2450,reservationCategory:'General',districts:['Lucknow'],urbanRural:'Urban'},
  {id:'con3',name:'Kolkata North',state:'West Bengal',type:'Lok Sabha',currentMP:'Ananya Chakraborty',currentParty:'TMC',voters:1650000,turnout2019:71.4,literacy:82,population:8900000,area:'187 sq km',pollingStations:1980,reservationCategory:'General',districts:['Kolkata'],urbanRural:'Urban'},
  {id:'con4',name:'Mumbai South',state:'Maharashtra',type:'Lok Sabha',currentMP:'Vacant',currentParty:'INC',voters:1420000,turnout2019:55.2,literacy:89,population:7600000,area:'32.6 sq km',pollingStations:1720,reservationCategory:'General',districts:['Mumbai City'],urbanRural:'Urban'},
];
...
export default function Constituency() {
  ...
  useEffect(() => {
    api.get('/api/constituency').then(r => { setAll(r.data.data || FALLBACK_CONSTITUENCIES); setFiltered(r.data.data || FALLBACK_CONSTITUENCIES); setLoading(false); })
      .catch(() => { setAll(FALLBACK_CONSTITUENCIES); setFiltered(FALLBACK_CONSTITUENCIES); setLoading(false); });
  }, []);
