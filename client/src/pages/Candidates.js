...
const FALLBACK_CANDIDATES = [
  {id:'c001',name:'Rajesh Kumar Sharma',party:'BJP',partyId:'bjp',constituency:'New Delhi',state:'Delhi',type:'Lok Sabha',age:52,gender:'Male',education:'MBA, Delhi University',assets:'₹4.2 Crore',netAssets:'₹3.4 Crore',criminalCases:0,winProbability:68,previousWins:2,attendance:82,questionsRaised:47,keyIssues:['Infrastructure','Employment','Anti-corruption'],bio:'Former Mayor of Delhi, known for urban infrastructure projects.',aiSummary:'Strong legislative record with 82% attendance.',publicRating:3.8,totalRatings:1240},
  {id:'c002',name:'Priya Nair Menon',party:'INC',partyId:'inc',constituency:'New Delhi',state:'Delhi',type:'Lok Sabha',age:44,gender:'Female',education:'LLB, JNU',assets:'₹1.8 Crore',netAssets:'₹1.5 Crore',criminalCases:0,winProbability:22,previousWins:0,attendance:0,questionsRaised:0,keyIssues:['Women Safety','Education','Healthcare'],bio:'Human rights lawyer turned politician.',aiSummary:'First-time candidate with strong grassroots credibility.',publicRating:4.1,totalRatings:820},
  {id:'c003',name:'Amit Tiwari',party:'AAP',partyId:'aap',constituency:'New Delhi',state:'Delhi',type:'Lok Sabha',age:38,gender:'Male',education:'B.Tech, IIT Delhi',assets:'₹92 Lakh',netAssets:'₹77 Lakh',criminalCases:0,winProbability:10,previousWins:0,attendance:88,questionsRaised:12,keyIssues:['Pollution','Water','Education'],bio:'IIT graduate focused on environmental issues.',aiSummary:'Strong technocratic credibility with environmental focus.',publicRating:3.6,totalRatings:540},
  {id:'c004',name:'Sunita Devi Yadav',party:'SP',partyId:'sp',constituency:'Lucknow',state:'Uttar Pradesh',type:'Lok Sabha',age:48,gender:'Female',education:'MA Political Science',assets:'₹2.6 Crore',netAssets:'₹2.2 Crore',criminalCases:1,winProbability:45,previousWins:2,attendance:79,questionsRaised:38,keyIssues:['Farmer welfare','OBC rights','Women empowerment'],bio:'Grassroots leader from agricultural background.',aiSummary:'Credible OBC-farmer voice with two legislative wins.',publicRating:3.9,totalRatings:1820},
  {id:'c006',name:'Ananya Chakraborty',party:'TMC',partyId:'tmc',constituency:'Kolkata North',state:'West Bengal',type:'Lok Sabha',age:41,gender:'Female',education:'MA Economics',assets:'₹3.1 Crore',netAssets:'₹2.5 Crore',criminalCases:0,winProbability:72,previousWins:2,attendance:85,questionsRaised:52,keyIssues:['Welfare schemes','Federalism','Women empowerment'],bio:'Former WB State Finance Minister.',aiSummary:'Strongest legislative record among all candidates.',publicRating:4.2,totalRatings:3100},
  {id:'c008',name:'Meera Patil Deshmukh',party:'INC',partyId:'inc',constituency:'Mumbai South',state:'Maharashtra',type:'Lok Sabha',age:46,gender:'Female',education:'MBBS, Grant Medical College',assets:'₹2.2 Crore',netAssets:'₹1.7 Crore',criminalCases:0,winProbability:38,previousWins:0,attendance:0,questionsRaised:0,keyIssues:['Healthcare','Housing','Coastal development'],bio:'Doctor-turned-politician focusing on public health.',aiSummary:'Unique MBBS+MD credentials for health policy.',publicRating:4.0,totalRatings:1040},
];
...
export default function Candidates() {
  ...
  useEffect(() => {
    ...
    api.get('/api/candidates')
      .then(r => { setAll(r.data.data || FALLBACK_CANDIDATES); setLoading(false); })
      .catch(() => { setAll(FALLBACK_CANDIDATES); setLoading(false); });
  }, []);
