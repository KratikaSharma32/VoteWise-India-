...
const FALLBACK_PARTIES = [
  {id:'bjp',name:'Bharatiya Janata Party',abbreviation:'BJP',founded:'1980',ideology:'Hindu nationalism, Conservatism',president:'J.P. Nadda',symbol:'Lotus',seatsWon:303,voteShare:37.4,description:'India\'s ruling party since 2014. Known for economic development and cultural nationalism.',manifesto:['Ram Mandir development','Uniform Civil Code','Digital India expansion','Agricultural modernisation','National security strengthening'],states:'18+'},
  {id:'inc',name:'Indian National Congress',abbreviation:'INC',founded:'1885',ideology:'Social democracy, Secularism',president:'Mallikarjun Kharge',symbol:'Hand',seatsWon:52,voteShare:19.5,description:'India\'s oldest political party. Led freedom movement and governed India for decades.',manifesto:['NYAY minimum income guarantee','Healthcare for all','Education investment','Farmer loan waiver','Women empowerment'],states:'3'},
  {id:'aap',name:'Aam Aadmi Party',abbreviation:'AAP',founded:'2012',ideology:'Anti-corruption, Populism',president:'Arvind Kejriwal',symbol:'Broom',seatsWon:0,voteShare:2.1,description:'Anti-corruption movement turned political party. Governs Delhi and Punjab.',manifesto:['Free electricity and water','Mohalla Clinics','Government school improvement','Anti-corruption drive','Honest governance'],states:'2'},
  {id:'sp',name:'Samajwadi Party',abbreviation:'SP',founded:'1992',ideology:'Socialism, OBC rights',president:'Akhilesh Yadav',symbol:'Bicycle',seatsWon:5,voteShare:2.6,description:'Major party in Uttar Pradesh focused on OBC communities and farmer welfare.',manifesto:['Farmer debt waiver','OBC sub-categorisation','Employment generation','Healthcare expansion','Free education'],states:'1'},
  {id:'tmc',name:'All India Trinamool Congress',abbreviation:'TMC',founded:'1998',ideology:'Bengali nationalism, Welfare politics',president:'Mamata Banerjee',symbol:'Flower and Grass',seatsWon:22,voteShare:4.1,description:'Dominant party in West Bengal known for welfare schemes like Duare Sarkar.',manifesto:['Duare Sarkar expansion','Lakshmi Bhandar scheme','Women empowerment','Federal rights','Bengali cultural protection'],states:'1'},
  {id:'bjd',name:'Biju Janata Dal',abbreviation:'BJD',founded:'1997',ideology:'Odisha regionalism, Development',president:'Naveen Patnaik',symbol:'Conch',seatsWon:12,voteShare:1.7,description:'Regional party governing Odisha known for disaster management and social schemes.',manifesto:['Biju Swasthya Kalyan expansion','Rural infrastructure','Tribal welfare','Agricultural development','Industrial growth'],states:'1'},
];
...
export default function Parties() {
  ...
  useEffect(() => {
    api.get('/api/parties')
      .then(r => { setParties(r.data.data || FALLBACK_PARTIES); setLoading(false); })
      .catch(() => { setParties(FALLBACK_PARTIES); setLoading(false); });
    api.get('/api/performance').then(r => setPerfData(r.data.data || [])).catch(() => {});
  }, []);
